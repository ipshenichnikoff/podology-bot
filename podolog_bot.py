...
PROCEDURES = [
    ("Педикюр",     60, 2500, 3500,
     "Дезинфекция и очищение стоп, аппаратная обработка стоп: удаление огрубевшей кожи, мозолей, натоптышей. Ручная обработка кутикулы и придание формы ногтям, расслабляющий массаж с питательным кремом. Результат — ухоженные стопы и ногти на 3–4 недели."),
    ("Удаление мозоли",  30, 1200, 2200,
     "Осмотр и определение типа мозоли (сухая, стержневая, натоптыш и т. д.). Аккуратное удаление уплотнения с минимальным воздействием на здоровые ткани. Антисептическая обработка зоны воздействия. Рекомендации по уходу и профилактике рецидивов. Результат — гладкая кожа и комфорт при ходьбе."),
    ("Удаление вросшего ногтя", 45, 1800, 3500,
     "Консультация и диагностика состояния ногтевой пластины и окружающих тканей. Аккуратное удаление вросшей части ногтя (или всей пластины при необходимости). Наложение стерильной повязки. Рекомендации по уходу и срокам заживления. Результат — устранение боли и воспаления, восстановление функции пальца."),
    ("Протезирование",   30, 1500, 3500,
     "Осмотр и оценка состояния ногтевого ложа. Подбор материала и формы протеза. Подготовка поверхности и фиксация протеза. Коррекция формы и полировка. Рекомендации по уходу. Результат — естественный вид ногтя и защита ногтевого ложа."),
    ("Титановая нить",     40, 3000, 6500,
     "Осмотр и оценка состояния ногтя. Подбор толщины и натяжения нити. Фиксация нити на ногтевой пластине. Рекомендации по уходу и срокам коррекции. Результат — здоровый рост ногтя без хирургического вмешательства."),
    ("ЗТО коррекционная система", 60, 4000, 6000,
     "Осмотр и оценка состояния ногтя. Подготовка ногтевой пластины. Установка и фиксация системы ЗТО. Рекомендации по уходу и срокам коррекции. Результат — здоровый рост ногтя без хирургического вмешательства."),
    ("Унибрейс", 60, 4500, 6500,
     "Методика включает диагностику степени врастания и воспаления, индивидуальный подбор размера и типа скобы, атравматичную установку конструкции, контроль коррекции в динамике, обучение правилам гигиены на период лечения. Подходит для взрослых и детей, при начальных и умеренных стадиях врастания."),
    ("Обработка трещин", 50, 1700, 3000,
     "Профессиональная обработка трещин стоп. Включает диагностику состояния кожи, аппаратное удаление гиперкератоза, антисептическую обработку трещин, нанесение заживляющих и смягчающих составов, подбор средств для домашнего ухода. Подходит для глубоких и застарелых трещин."),
    ("Зачистка ногтевой пластины", 30, 500, 2000,
     "Осмотр и оценка состояния ногтя. Зачистка пораженной части ногтя до полного его отрастания"),
]
